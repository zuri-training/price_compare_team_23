...
login.addEventListener("click", () => {
  if (fname.value.length == "") {
    ...
    sp1.innerHTML =
      "first name cannot be empty <img src='close-circle.svg' alt=''>";
  }

  if (lname.value == "") {
    lname.classList.add("invalid");
    sp2.innerHTML =
      "last name cannot be empty <img src='close-circle.svg' alt=''>";
  }
  ...
  if (username.value == "") {
    ...
    sp4.innerHTML =
      "Enter a valid username <img src='close-circle.svg' alt=''>";
  }

  if (pass1.value == "") {
    pass1.classList.add("invalid");
    sp6.innerHTML =
      "password must be greater than six characters <img src='close-circle.svg' alt=''>";
  }
...
function log5() {
  if (pass2.value.length <= 5) {
    pass2.classList.add("invalid");
    sp5.innerHTML =
      "<p>Password must match</p> <img src='close-circle.svg' alt=''>";
  } else {
...
function log6() {
  if (pass1.value.length <= 5) {
    pass1.classList.add("invalid");
    sp6.innerHTML =
      "<p>Password must be greater than six</p> <img src='close-circle.svg' alt=''>";
  } else {
